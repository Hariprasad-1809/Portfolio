...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center overflow-hidden relative py-16 lg:py-20">
      <div className="max-w-7xl w-full px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] items-center gap-10 lg:gap-16">
          <div className="max-w-2xl justify-self-center lg:justify-self-start text-center lg:text-left overflow-hidden">
            <h1 className="font-body uppercase text-[clamp(3.5rem,7.5vw,6.5rem)] leading-[0.95] tracking-wide text-charcoal dark:text-offwhite" style={{ whiteSpace: 'nowrap' }}>
              {largeText}
            </h1>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-center lg:justify-start gap-3">
                ...
                <Link to="/contact" className="inline-block">
                  <button className="px-4 py-2 rounded-full border border-black/6 text-sm">Contact</button>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex justify-center lg:justify-end">
            <img
              ...
              className="w-80 h-80 lg:w-96 lg:h-96 rounded-md object-cover border border-black/6 bg-white shadow-[0_30px_90px_rgba(0,0,0,0.14)] dark:shadow-[0_30px_90px_rgba(0,0,0,0.35)]"
